...
class _SignUpStep2State extends State<SignUpStep2> {
  ...
  String? _extractFieldErrorFromPayload(dynamic payload, String fieldName) {
    ...
    if (payload is Map) {
      ...
      final fromData =
          _extractFieldErrorFromPayload(payload['data'], fieldName);
      if (fromData != null && fromData.isNotEmpty) return fromData;

      final fromMessage =
          _extractFieldErrorFromPayload(payload['message'], fieldName);
      ...
      body: SafeArea(
        child: SingleChildScrollView(
          ...
          child:
                  ...
                  child: CircleAvatar(
                      ...
                      backgroundImage: _avatarFile != null
                          ...
                          : (_selectedAvatarUrl != null
                              ...
                              : null),
                      child: _avatarFile == null && _selectedAvatarUrl == null
            ...
            const Text('Or Select Profile Photo', textAlign: TextAlign.center),
            const SizedBox(height: 12),
            _buildInput(
                label: 'Name',
              ...
              child: TextButton(
                  onPressed: () async {
                    ...
                    try {
                      ...
                      final res = await auth.api
                          .requestRegistrationOtp(widget.email.trim());
                      Navigator.of(context).pop();
                      if (res['success'] == 1) {
                ...
                child: ElevatedButton(
                    ...
                    onPressed: () async {
                      ...
                      try {
                        ...
                        if (res['success'] == 1) {
                          ...
                          try {
                            ...
                            await prefs.setString(
                                'phone_to_username:$phone', name);
                          } catch (_) {}

                          // If the user picked a file avatar, upload it now.
                          try {
                            if (_avatarFile != null) {
                              await auth.updateProfile({'phone': phone},
                                  avatar: _avatarFile);
                        ...
                        final backendNameError = _extractFieldErrorFromPayload(
                                res, 'username') ??
                        ...
                        final fallbackText = NotificationService.formatMessage(
                            res['message'] ??
                                res['data'] ??
                                'Registration failed');
