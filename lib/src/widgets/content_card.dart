    ...
    try {
      ...
      if (c is Map && c['id'] != null) {
        ...
        selectedCategoryId = int.tryParse(
          widget.content['category_id'].toString(),
        );
    ...
    try {
      ...
      if (e is ApiException) {
        ...
        final alreadyReported =
            e.code == 409 || body.contains('already reported this post');
        if (alreadyReported) {
          notifications.showWarning('You already reported this post.');
          return;
        }
      }
      final msg = e is ApiException
                ...
                onTap: () async {
                  ...
                  try {
                    ...
                    notifications.showError(
                      NotificationService.formatMessage(msg),
                    );
                  }
                },
              ),
  ...
  Future<void> _toggleLike() async {
    ...
    try {
      ...
      setState(() {
        _isLiked = !_isLiked;
        if (current2 != null) {
          _likesDisplay = (_isLiked ? (current2 + 1) : (current2 - 1))
              .toString();
        }
      });
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      padding: EdgeInsets.symmetric(
        horizontal: useWideLayout ? 20 : 12,
        vertical: 8,
      ),
      child: Align(
                            ...
                            onViewMore: () async {
                              ...
                              if (result is Map<String, dynamic>) {
                                ...
                                try {
                                  ...
                                  final fresh = await api.getContentById(
                                    contentId,
                                  );
                                  widget.onUpdated?.call(fresh);
                                } catch (_) {}
